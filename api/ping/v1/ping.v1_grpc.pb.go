...
func (c *srvPingClient) Ping(ctx context.Context, in *PingReq, opts ...grpc.CallOption) (*PingResp, error) {
	out := new(PingResp)
	err := c.cc.Invoke(ctx, "/kit.api.ping.pingv1.SrvPing/Ping", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedSrvPingServer) Ping(context.Context, *PingReq) (*PingResp, error) {
...
func _SrvPing_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/kit.api.ping.pingv1.SrvPing/Ping",
	}
...
var SrvPing_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "kit.api.ping.pingv1.SrvPing",
	...
	Metadata: "api/ping/v1/ping.v1.proto",
}
