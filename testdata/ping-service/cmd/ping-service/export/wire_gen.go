...
import (
	...
	"github.com/ikaiguang/go-srv-kit/service/setup_v2"
...
func exportServices(launcherManager setupv2.LauncherManager, hs *http.Server, gs *grpc.Server) (cleanuputil.CleanupManager, error) {
	logger, err := setupv2.GetLogger(launcherManager)
	if err != nil {
		return nil, err
	}
	...
	serviceAPIManager, err := setupv2.GetServiceAPIManager(launcherManager)
	if err != nil {
		return nil, err
	}
