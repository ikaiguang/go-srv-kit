...
func (x *Config) Reset() {
	*x = Config{}
	if protoimpl.UnsafeEnabled {
		mi := &file_postgres_config_proto_msgTypes[0]
...
func (*Config) Descriptor() ([]byte, []int) {
	return file_postgres_config_proto_rawDescGZIP(), []int{0}
}
...
var File_postgres_config_proto protoreflect.FileDescriptor

var file_postgres_config_proto_rawDesc = []byte{
	0x0a, 0x15, 0x70, 0x6f, 0x73, 0x74, 0x67, 0x72, 0x65, 0x73, 0x2f, 0x63, 0x6f, 0x6e, 0x66, 0x69,
	0x67, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0b, 0x6b, 0x69, 0x74, 0x2e, 0x70, 0x73, 0x71,
	0x6c, 0x70, 0x6b, 0x67, 0x1a, 0x1e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2f, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x62, 0x75, 0x66, 0x2f, 0x64, 0x75, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x70,
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0xc0, 0x03, 0x0a, 0x06, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12,
	0x16, 0x0a, 0x06, 0x65, 0x6e, 0x61, 0x62, 0x6c, 0x65, 0x18, 0x64, 0x20, 0x01, 0x28, 0x08, 0x52,
	0x06, 0x65, 0x6e, 0x61, 0x62, 0x6c, 0x65, 0x12, 0x10, 0x0a, 0x03, 0x64, 0x73, 0x6e, 0x18, 0x01,
	...
	0x64, 0x6c, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x42, 0x52, 0x0a, 0x0b, 0x6b, 0x69, 0x74, 0x2e, 0x70,
	0x73, 0x71, 0x6c, 0x70, 0x6b, 0x67, 0x42, 0x0a, 0x4b, 0x69, 0x74, 0x50, 0x73, 0x71, 0x6c, 0x50,
	0x4b, 0x47, 0x50, 0x01, 0x5a, 0x35, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d,
	0x2f, 0x69, 0x6b, 0x61, 0x69, 0x67, 0x75, 0x61, 0x6e, 0x67, 0x2f, 0x67, 0x6f, 0x2d, 0x70, 0x6f,
	0x73, 0x74, 0x67, 0x72, 0x65, 0x73, 0x2d, 0x6b, 0x69, 0x74, 0x2f, 0x70, 0x6f, 0x73, 0x74, 0x67,
	0x72, 0x65, 0x73, 0x3b, 0x70, 0x73, 0x71, 0x6c, 0x70, 0x6b, 0x67, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}

var (
	file_postgres_config_proto_rawDescOnce sync.Once
	file_postgres_config_proto_rawDescData = file_postgres_config_proto_rawDesc
)

func file_postgres_config_proto_rawDescGZIP() []byte {
	file_postgres_config_proto_rawDescOnce.Do(func() {
		file_postgres_config_proto_rawDescData = protoimpl.X.CompressGZIP(file_postgres_config_proto_rawDescData)
	})
	return file_postgres_config_proto_rawDescData
}

var file_postgres_config_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_postgres_config_proto_goTypes = []any{
	(*Config)(nil),              // 0: kit.psqlpkg.Config
	(*durationpb.Duration)(nil), // 1: google.protobuf.Duration
}
var file_postgres_config_proto_depIdxs = []int32{
	1, // 0: kit.psqlpkg.Config.slow_threshold:type_name -> google.protobuf.Duration
	1, // 1: kit.psqlpkg.Config.conn_max_lifetime:type_name -> google.protobuf.Duration
	1, // 2: kit.psqlpkg.Config.conn_max_idle_time:type_name -> google.protobuf.Duration
...
func init() { file_postgres_config_proto_init() }
func file_postgres_config_proto_init() {
	if File_postgres_config_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_postgres_config_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Config); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_postgres_config_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_postgres_config_proto_goTypes,
		DependencyIndexes: file_postgres_config_proto_depIdxs,
		MessageInfos:      file_postgres_config_proto_msgTypes,
	}.Build()
	File_postgres_config_proto = out.File
	file_postgres_config_proto_rawDesc = nil
	file_postgres_config_proto_goTypes = nil
	file_postgres_config_proto_depIdxs = nil
}
