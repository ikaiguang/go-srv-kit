module github.com/ikaiguang/go-srv-kit/service/auth

go 1.25.9

require (
	github.com/ikaiguang/go-srv-kit v0.0.0
	github.com/ikaiguang/go-srv-kit/data/redis v0.0.0
	github.com/ikaiguang/go-srv-kit/kratos v0.0.0
	github.com/ikaiguang/go-srv-kit/kratos/auth/redis v0.0.0
	github.com/ikaiguang/go-srv-kit/service v0.0.0
	github.com/ikaiguang/go-srv-kit/service/redis v0.0.0
...
replace github.com/ikaiguang/go-srv-kit/kratos/auth/redis => ../../kratos/auth/redis

replace github.com/ikaiguang/go-srv-kit/service => ..

replace github.com/ikaiguang/go-srv-kit/service/redis => ../redis
