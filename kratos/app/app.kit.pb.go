...
var file_kratos_app_app_kit_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x42, 0x53, 0x0a,
...
func file_kratos_app_app_kit_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_kratos_app_app_kit_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Result); i {
			case 0:
				return &v.state
			case 1:
