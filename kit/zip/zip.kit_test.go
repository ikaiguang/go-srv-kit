...
// go test -v -count=1 ./pkg/zip -run TestZipFile
...
// go test -v -count=1 ./pkg/zip -run TestZip_Xxx
...
// go test -v -count=1 ./pkg/zip -run TestZip_File
...
// go test -v -count=1 ./pkg/zip -run TestUnzip
