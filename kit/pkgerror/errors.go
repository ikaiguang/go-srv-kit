// Package pkgerror provides simple error handling primitives.
//
...
// investigation. Cause detects cycles for comparable error values. For the
// unusual case of a chain made entirely from non-comparable error values,
// traversal stops after 10,000 links so a malformed chain cannot loop forever.
